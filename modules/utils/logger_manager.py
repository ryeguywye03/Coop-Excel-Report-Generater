...
class LoggerManager:
    ...
    def __init__(self, log_dir="logs", enable_logging=True, console_level=logging.WARNING):
        ...
        try:
            ...
            print(f"Resolved log directory: {self.log_dir}")
            ...
            if not self.check_log_directory():
                print(f"Log directory {self.log_dir} is not writable. Disabling logging.")
            ...
            print(f"Failed to initialize LoggerManager: {e}")
            self.enable_logging = False
